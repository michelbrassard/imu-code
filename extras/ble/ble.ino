...
#define BLE_ACCELERATION_CHARACTERISTIC_UUID "2D77" // left as is, not on the list (Generated)
#define BLE_GYRO_CHARACTERISTIC_UUID "2D76" // left as is, not on the list
